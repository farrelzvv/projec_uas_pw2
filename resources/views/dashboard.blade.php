...
<html lang="en">
  ...
  <body>
    ...
    <section class="section__container registration__container" id="Regist">
      <div class="registration__content">
        <h2 class="section__header">Daftarkan UMKM Anda</h2>
    ...
    <script>
      document.getElementById('registrationForm').addEventListener('submit', function(event) {
        ...
        registrationMessage.textContent = 'Terima kasih telah mendaftar!';
      });
    </script>
  </body>
</html>
